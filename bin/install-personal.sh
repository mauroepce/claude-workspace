...
echo "To uninstall: rm -rf ~/.claude/commands/{work,issue,debug,conventions,architecture-map,journeys-diagram,decision,code-review,safe-commit,safe-push,scaffold}.md ~/.claude/templates/"
echo ""
